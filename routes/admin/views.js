...
const view_admin_requests = async (req, res) => {
    ...
    try {
        ...
        return res.render('admin/admin_requests.ejs', { requests: results, message: message, msg_type: msg_type });
    }
    catch {
...
const view_checkout_requests = async (req, res) => {
    ...
    try {
        results = await execute_query(query, []);
        return res.render('admin/checkout_requests.ejs', { checkout_requests: results, message: message, msg_type: msg_type });
    }
    catch {
...
const view_checkin_requests = async (req, res) => {
    ...
    try {
        results = await execute_query(query, []);
        return res.render('admin/checkin_requests.ejs', { checkin_requests: results, message: message, msg_type: msg_type });
    }
    catch {
...
const view_delete_book = async (req, res) => {
    ...
    try {
        results = await execute_query(query);
        return res.render("admin/delete_book.ejs", { books: results, message: message, msg_type: msg_type });
    }
    catch {
        return res.render("admin/delete_book.ejs", { books: [], message: "Failed to Fetch Books!", msg_type: "error" });
...
const view_update_book = async (req, res) => {
    ...
    try {
        results = await execute_query(query);
        return res.render("admin/update_book.ejs", { books: results, message: message, msg_type: msg_type });
    }
    catch {
        return res.render("admin/update_book.ejs", { books: [], message: "Failed to Fetch Books!", msg_type: "error" });
    }
};
...
module.exports = { home_view, view_admin_requests, view_checkout_requests, view_checkin_requests, view_add_book, view_update_book, view_delete_book, view_transaction_history };