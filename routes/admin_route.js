...
const view_update_book = async (req, res) => {
    ...
    try {
        ...
        return res.render("../views/update_book.ejs", { message: "Failed to Fetch Books!", msg_type: "error" });
    }
}
...
const view_delete_book = async (req, res) => {
    ...
    try {
        ...
        return res.render("../views/delete_book.ejs", { message: "Failed to Fetch Books!", msg_type: "error" })
